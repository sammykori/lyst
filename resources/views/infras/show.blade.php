@extends('layouts.lapp')
    ...
    @section('content')
     <div class="container">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Communications Tower Infrastructure Licence - Profile of {{$deal->company_name}}</h1>
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                {!!Form::open(['action' => ['InfrasController@update', $deal->id],'method' => 'PUT'])!!}
