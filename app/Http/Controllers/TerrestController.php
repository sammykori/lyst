...
use App\Exports\TerrestExport;
use Maatwebsite\Excel\Facades\Excel;

class TerrestController extends Controller
{
    /**
    ...
    {
        $deal = Dealers::where('status', 'licenced')->where('service_id', 6)->get();

        return view('terrest.index')->with('deal', $deal);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/terrest')->withSuccess('New requested submitted');
    }
    ...
    public function show($id)
    {
        ...
        return view('terrest.show')->with('deal', $deal[0]);
    }
    ...
    {
        return Excel::download(new TerrestExport(), 'terrestrial.xlsx');
    }
}
