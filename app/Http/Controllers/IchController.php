...
use App\Dealers;
use App\Exports\IchExport;
use Illuminate\Support\Facades\DB;
use Maatwebsite\Excel\Facades\Excel;

class IchController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('ich.index')->with('deal', $deal);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/ich')->withSuccess('New requested submitted');
    }
    ...
    public function show($id)
    {
        ...
        return view('ich.show')->with('deal', $deal[0]);
    }
    ...
    {
        return Excel::download(new IchExport(), 'ich.xlsx');
    }
}
