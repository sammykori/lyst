...
use App\Exports\IglExport;
use Maatwebsite\Excel\Facades\Excel;

class IglController extends Controller
{
    /**
    ...
    {
        $deal = Dealers::where('status', 'licenced')->where('service_id', 5)->get();

        return view('igl.index')->with('deal', $deal);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/igl')->withSuccess('New requested submitted');
    }
    ...
    public function show($id)
    {
        ...
        return view('igl.show')->with('deal', $deal[0]);
    }
    ...
    {
        return Excel::download(new IglExport(), 'igl.xlsx');
    }
}
