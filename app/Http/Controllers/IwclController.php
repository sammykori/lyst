...
use App\Exports\IwclExport;
use Maatwebsite\Excel\Facades\Excel;

class IwclController extends Controller
{
    /**
    ...
    {
        $deal = Dealers::where('status', 'licenced')->where('service_id', 8)->get();

        return view('iwcl.index')->with('deal', $deal);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/iwcl')->withSuccess('New requested submitted');
    }
    ...
    public function show($id)
    {
        ...
        return view('iwcl.show')->with('deal', $deal[0]);
    }
    ...
    {
        return Excel::download(new IwclExport(), 'iwcl.xlsx');
    }
}
