...
class VirtualController extends Controller
{
    ...
    {
        $deal = Dealers::where('status', 'licenced')->where('service_id', 7)->get();

        return view('virtual.index')->with('deal', $deal);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/virtual')->withSuccess('New requested submitted');
    }
    ...
    public function show($id)
    {
        ...
        return view('virtual.show')->with('deal', $deal[0]);
    }
    ...
    public function revoke(Request $request)
    {
        ...
        return redirect('/virtual')->withSuccess("Licence Revoke Successfully");
    }
    public function export()
    {
        return Excel::download(new VirtualExport(), 'virtual.xlsx');
    }
}
