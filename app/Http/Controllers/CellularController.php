...
use App\Exports\CellularExport;
...
class CellularController extends Controller
{
    ...
    {
        $deal = Dealers::where('status', 'licenced')->where('service_id', 2)->get();

        return view('cellular.index')->with('deal', $deal);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/cellular')->withSuccess('New requested submitted');
    }
    ...
    public function show($id)
    {
        ...
        return view('cellular.show')->with('deal', $deal[0]);
    }
    ...
    {
        return Excel::download(new CellularExport(), 'cellular.xlsx');
    }
}
