...
class VasController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('vas.index')->with('deal', $deal);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/vas')->withSuccess('New requested submitted');
    }
    ...
    public function show($id)
    {
        ...
        return view('vas.show')->with('deal', $deal[0]);
    }
    ...
    {
        return Excel::download(new VasExport(), 'vas.xlsx');
    }
}
