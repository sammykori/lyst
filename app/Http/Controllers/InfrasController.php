...
class InfrasController extends Controller
{
    ...
    {
        $deal = Dealers::where('status', 'licenced')->where('service_id', 10)->get();

        return view('infras.index')->with('deal', $deal);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/infras')->withSuccess('New requested submitted');
    }
    ...
    public function show($id)
    {
        ...
        return view('infras.show')->with('deal', $deal[0]);
    }
    ...
    {
        return Excel::download(new InfrasExport(), 'infrastructure.xlsx');
    }
}
