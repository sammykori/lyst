...
class BwaController extends Controller
{
    ...
    {
        $deal = Dealers::where('status', 'licenced')->where('service_id', 4)->get();

        return view('bwa.index')->with('deal', $deal);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/bwa')->withSuccess('New requested submitted');
    }
    ...
    public function show($id)
    {
        ...
        return view('bwa.show')->with('deal', $deal[0]);
    }
    ...
    {
        return Excel::download(new BwaExport(), 'bwa.xlsx');
    }
}
