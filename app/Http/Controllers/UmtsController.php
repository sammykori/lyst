...
use App\Exports\UmtsExport;
use Maatwebsite\Excel\Facades\Excel;

class UmtsController extends Controller
{
    /**
    ...
    {
        $deal = Dealers::where('status', 'licenced')->where('service_id', 3)->get();

        return view('umts.index')->with('deal', $deal);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/umts')->withSuccess('New requested submitted');
    }
    ...
    public function show($id)
    {
        ...
        return view('umts.show')->with('deal', $deal[0]);
    }
    ...
    {
        return Excel::download(new UmtsExport(), 'umts.xlsx');
    }
}
